...
#### Rewards:
- ![five](src/main/resources/img5.png) Points are awarded for a working simulation of Langton's Ant with a simple user interface to display the grid and the ant's movement.
- ![three](src/main/resources/img3.png)  Further points are awarded for creating your simulation in a unique choice of language (or a unique frontend JavaScript framework).
- ![two](src/main/resources/img2.png)  Further points are awarded for expanding the grid by one cell in all directions if the ant attempts to move outside of the grid.
...
![langant_360.gif](src/main/resources/langant_360.gif)