...
//        assertEquals("\u001b[1;4;30;42m", colours.getUnicodeStringParams(BOLD, UNDERLINE, BLACK, GREEN_BACKGROUND));
    ...
    void getUnicodeStringRGB() {
        Colours colours = new Colours();
        assertEquals("\u001b[38;2;2;55;66m", colours.getUnicodeStringRGB(2, 55, 66));
        assertEquals("\u001b[1;38;2;2;55;66m", colours.getUnicodeStringRGB(2, 55, 66, Format.BOLD));
        assertEquals("\u001b[4;38;2;2;55;66m", colours.getUnicodeStringRGB(2, 55, 66, Format.UNDERLINE));
        assertEquals("\u001b[1;4;38;2;2;55;66m", colours.getUnicodeStringRGB(2, 55, 66, Format.BOLD, Format.UNDERLINE));
...
//        assertEquals("\u001b[1;4;30;42m", colours.getUnicodeStringParams(BOLD, UNDERLINE, BLACK, GREEN_BACKGROUND));
    ...
    void test2() {
        ...
        System.out.println("Blank");
        System.out.println(new Colours().getUnicodeStringRGB(2, 255, 66, Format.BOLD) + "Testing" + RESET);
        System.out.println(new Colours().getUnicodeStringRGB(100, 55, 66, Format.UNDERLINE) + "Testing" + RESET);
        System.out.println(new Colours().getUnicodeStringRGB(2, 55, 166, Format.BOLD, Format.UNDERLINE) + "Testing" + RESET);
        System.out.println("Blank");
    }
}